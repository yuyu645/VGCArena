...
const { rateLimiter, securityHeaders } = require('./server/middleware/security');

const app = express();
const PORT = process.env.PORT || 3000;

// Necesario para que req.ip refleje la IP real detrás de un proxy (Render,
// Nginx, etc.). Sin esto todas la
// 
// s peticiones comparten IP y el rate limiter
...
app.use('/api/teams', favoriteRoutes); // /api/teams/:id/favorite
